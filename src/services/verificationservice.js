...
export const loadRecords = async (q, setLoading, setErrorMsg, setRecords) => {
  ...
  try {
    ...
    const mapped = rows.map((r) => ({
      ...
      second_enrollment_id: r.second_enrollment_id || (r.second_enrollment && (r.second_enrollment.enrollment_no || r.second_enrollment.id)) || '',
      second_enrollment_no: r.second_enrollment_no || r.second_enrollment_id || (r.second_enrollment && r.second_enrollment.enrollment_no) || '',
      second_enrollment: r.second_enrollment || null,
