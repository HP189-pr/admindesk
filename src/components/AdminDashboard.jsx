...
const AdminDashboard = ({ selectedTopbarMenu }) => {
  ...
  const renderContent = () => {
    switch (selectedTopbarMenu) {
      ...
      case "User Rights":
        return <h2 className="text-xl font-semibold">🔒 User Rights Management</h2>;

      case "Add College":
        return <h2 className="text-xl font-semibold">🏛️ Add College Form</h2>;

      case "Add Course":
        return <h2 className="text-xl font-semibold">📚 Add Course Form</h2>;
