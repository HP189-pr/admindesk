...
export interface ApiHolidayHoliday extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hdid: Schema.Attribute.Integer & Schema.Attribute.Unique;
    holiday_date: Schema.Attribute.Date;
    holiday_day: Schema.Attribute.String;
    holiday_name: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::holiday.holiday'
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    moduleid: Schema.Attribute.Integer & Schema.Attribute.Unique;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedat: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedby: Schema.Attribute.Integer;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
}
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usercode: Schema.Attribute.String & Schema.Attribute.Required;
    userid: Schema.Attribute.Integer & Schema.Attribute.Unique;
    username: Schema.Attribute.String & Schema.Attribute.Required;
    usertype: Schema.Attribute.String & Schema.Attribute.Required;
    usrpassword: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
