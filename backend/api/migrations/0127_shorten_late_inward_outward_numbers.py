...
def shorten_numbers(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0126_shorten_inout_register_numbers'),
    ]

    operations = [
        migrations.RunPython(shorten_numbers, reverse_code=migrations.RunPython.noop),
    ]
